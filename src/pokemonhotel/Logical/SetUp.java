...
public class SetUp
{
    ...
    public void AssignPokemon(Collections collections)
    {
        ...
        //used to track if pokemon is assigned a room and personal assistant
        Boolean isAssigned;
        ...
        for (Pokemon poke : pokemon)
        {
            ...
            //iterate over rooms to find suitable room
            for (Room room : rooms)
            {
                //sucess room found
            ...
            //if room found try and find personal assistant
            if (isAssigned == true)
            {
                //reset to false
                isAssigned = false;
                ...
                {
                    //check if personal assistant is suitable
